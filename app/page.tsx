        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 flex flex-col items-center justify-center h-screen">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="max-w-4xl mt-6">
              ...
              <p className="sm:text-xl/relaxed text-gray-400">
              ...
              <div className="flex items-center justify-center gap-4 mt-6">
                <input
                  ...
                  className="border rounded-md focus:outline-none focus:border-transparent focus:ring-0 px-4 py-2 w-full text-black"
                />
              </div>
              ...
              {fullName && fullName.length >= 3 && (
                <>
                  ...
                  <div>
                    <button
                      className="text-lg font-medium mt-4 text-white hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 transition-all duration-300 cursor-pointer relative group"
